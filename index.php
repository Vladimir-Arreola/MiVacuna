...
<body>
    ...
    <div class="barra">
        <a href="paginas/login.php" class="link">Iniciar sesión</a>
    </div>
    <main class="all-container">
        <div class="carga-curp"  id="box">
            ...
            <form action="paginas/form_curp.php" method="post" id="manda-curp" class="form-group" onsubmit="return ValidaCurp()">
    ...
    <p class="paragraph paragraph-time">El horario de operación es continuo de lunes a domingo.</p>
    <footer class="paragraph-footer">
