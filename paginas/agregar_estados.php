...
<header class="cabecera-admin">
    ...
    <div class="contenedor-tablas sombra">
        ...
        <form action="guardar_estado.php" method="post" id="actual" class="form-update" onsubmit="return ValidarEstados();">
        <div class="form-container">
            ...
            <div class="input-container" id="contenedor-estado">
                ...
                <input class="input-curp" name="estado" id="estado" maxlength="18">
            </div>     
        </div>  
