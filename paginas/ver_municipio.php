<?php 
    ...
    $sql = "SELECT M.id_municipio, E.nombre_estado, M.nombre_municipio FROM municipios M INNER JOIN estados E on M.id_estado = E.id_estado WHERE id_municipio=".$municipioSelec;
